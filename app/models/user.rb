...
class User < ApplicationRecord
  ...
  has_many :accepted_invitations, -> { where(confirmed: true) }, class_name: "Invitation", foreign_key: "friend_id", dependent: :destroy
  ...
  has_one_attached :background_photo, dependent: :destroy
